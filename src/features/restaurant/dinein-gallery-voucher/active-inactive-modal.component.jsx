...
import { useDeleteDineInVoucherMutation } from "./dinein-gallery-voucher-api";

export const ActiveInactiveModal = ({ show, onClose, selectedRow }) => {
  const [deleteDineInVoucher, { data, isSuccess, isLoading }] =
  ...
  const onDelete = async () => {
    await deleteDineInVoucher(selectedRow);
  };

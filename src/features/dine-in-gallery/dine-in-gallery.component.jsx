...
export const DineInGallery = () => {
  const breadcrumbItems = [{ name: "Foodie" }, { name: "Dine in Gallery" }];
  ...
  return (
    <CommonLayout
      ...
      BtnComp={<LinkButton to="/dine-in-gallery/create" btnName="Create" />}
    >
      <CommonTable

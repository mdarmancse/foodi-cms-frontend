...
import { useDeleteRiderShiftBookingMutation } from "./rider-shift-booking-api";

export const ActiveInactiveModal = ({ show, onClose, selectedRow }) => {
  const [deleteRiderShift, { data, isSuccess, isLoading }] =
  ...
  const onDelete = async () => {
    await deleteRiderShift(selectedRow);
  };

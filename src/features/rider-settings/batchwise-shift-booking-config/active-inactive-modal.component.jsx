...
import { useDeleteBatchwiseShiftMutation } from "./batchwise-shift-booking-api";

export const ActiveInactiveModal = ({ show, onClose, selectedRow }) => {
  const [deleteBatchwiseShift, { data, isSuccess, isLoading }] =
  ...
  const onDelete = async () => {
    await deleteBatchwiseShift(selectedRow);
  };

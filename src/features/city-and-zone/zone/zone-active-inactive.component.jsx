...
import { useDeleteZoneMutation } from "./zone-api-slice";

export const ZoneActiveInactive = ({ show, onClose, selectedRow }) => {
  const [deleteMenu, { data, isSuccess, isLoading, error, isError }] =

...
import { useRemoveAmountThresholdMutation } from "./amount-thresholds-api";

export const ActiveInactiveModal = ({ show, onClose, selectedRow }) => {
  const [RemoveThresholdList, { data, isSuccess, isLoading }] =
  ...
  const onDelete = async () => {
    await RemoveThresholdList(selectedRow);
  };
